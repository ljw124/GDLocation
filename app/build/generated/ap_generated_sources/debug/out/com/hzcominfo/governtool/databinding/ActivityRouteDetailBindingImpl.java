...
public class ActivityRouteDetailBindingImpl extends ActivityRouteDetailBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ib_location, 6);
        sViewsWithIds.put(R.id.ib_return, 7);
        sViewsWithIds.put(R.id.ll_route_info, 8);
    }
    // views
    @NonNull
    ...
    private ActivityRouteDetailBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 5
            ...
            , (com.amap.api.maps.MapView) bindings[5]
            );
    ...
    protected void executeBindings() {
        ...
        java.lang.String mboundView2AndroidStringRecordTimeModelRecordTime = null;
        java.lang.String modelWalkTimeGet = null;
        java.lang.String mboundView4AndroidStringWalkDistanceModelWalkDistance = null;
        androidx.databinding.ObservableField<java.lang.String> modelRecordTime = null;
        java.lang.String mboundView4AndroidStringWalkDistanceModelWalkDistanceMboundView4AndroidStringKm = null;
        ...
        java.lang.String mboundView3AndroidStringWalkTimeModelWalkTime = null;
        ...
        if ((dirtyFlags & 0x3fL) != 0) {
            ...
            if ((dirtyFlags & 0x25L) != 0) {
                    ...
                    mboundView4AndroidStringWalkDistanceModelWalkDistance = (mboundView4.getResources().getString(R.string.walk_distance)) + (modelWalkDistanceGet);


                    // read ((@android:string/walk_distance) + (model.walkDistance.get())) + (@android:string/km)
                    mboundView4AndroidStringWalkDistanceModelWalkDistanceMboundView4AndroidStringKm = (mboundView4AndroidStringWalkDistanceModelWalkDistance) + (mboundView4.getResources().getString(R.string.km));
            }
            if ((dirtyFlags & 0x29L) != 0) {
                    ...
                    mboundView2AndroidStringRecordTimeModelRecordTime = (mboundView2.getResources().getString(R.string.record_time)) + (modelRecordTimeGet);
            }
            if ((dirtyFlags & 0x31L) != 0) {
                    ...
                    mboundView3AndroidStringWalkTimeModelWalkTime = (mboundView3.getResources().getString(R.string.walk_time)) + (modelWalkTimeGet);
            }
        }
        // batch finished
        if ((dirtyFlags & 0x23L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView1, modelWalkNameGet);
        }
        if ((dirtyFlags & 0x29L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView2, mboundView2AndroidStringRecordTimeModelRecordTime);
        }
        if ((dirtyFlags & 0x31L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView3, mboundView3AndroidStringWalkTimeModelWalkTime);
        }
        if ((dirtyFlags & 0x25L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView4, mboundView4AndroidStringWalkDistanceModelWalkDistanceMboundView4AndroidStringKm);
        }
    }
